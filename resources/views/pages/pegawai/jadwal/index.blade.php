...
@section('title', 'Agenda Rapat - Pegawai')
                ...
                <button id="profileBtn" class="p-2 rounded hover:bg-gray-100 transition" title="Profil">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 
...
<script>
    ...
    searchInput.addEventListener('keyup', function () {
        ...
        fetch(`/pegawai/jadwal/search?q=${q}`)
            .then(res => res.json())
            .then(data => {
                let rows = "";
                ...
                if (data.length === 0) {
                    rows = `
                        <tr>
                            <td colspan="7" class="px-4 py-6 text-center text-gray-400">
                                Tidak ada agenda rapat ditemukan.
                            </td>
                        </tr>`;
                } else {
                    data.forEach(r => {
                        rows += `
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-4 py-4 whitespace-nowrap">
                                    <a href="/pegawai/jadwal/${r.id}" class="text-blue-600 hover:underline">Detail</a>
                                </td>
                            </tr>`;
                    });
                }
