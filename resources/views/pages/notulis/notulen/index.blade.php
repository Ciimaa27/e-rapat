    ...
    <section class="bg-white rounded-lg p-4 shadow border">
        ...
        <div class="flex flex-col md:flex-row items-stretch md:items-center gap-4 mb-6">
            ...
            <div class="flex justify-end">
                <button class="px-4 py-2 bg-pink-custom text-brand-green font-semibold rounded-lg text-sm hover-pink-custom-hover transition whitespace-nowrap flex items-center gap-2">
        ...
        <div class="border-2 border-gray-200 rounded-lg overflow-hidden overflow-x-auto">
            <table role="table" aria-label="Daftar Notulen" class="min-w-full divide-y divide-gray-200 text-sm table-divider">
                ...
                <tbody>
                    @forelse ($rapats as $item)
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-4 md:px-6 py-4 font-medium text-brand-green">
                                {{ $item->judul_rapat }}
                            </td>
